...
export default function Privacy() {
  return (
    <main className="mx-auto max-w-[68ch] px-11 py-29 md:px-16 md:py-34">
      <h1 className="text-[34px] leading-[1.1] font-bold tracking-[-0.8px] md:text-display">Privacy</h1>
      ...
      <div className="mt-29 flex flex-col gap-16 md:mt-34">
        ...
        <section>
          <h2 className="text-[16px] leading-[1.3] font-bold tracking-[-0.3px]">Who it is shared with</h2>
          <p className="mt-6 text-ink-subtle">Nobody. It is not sold.</p>
        </section>

        <section>
          <h2 className="text-[16px] leading-[1.3] font-bold tracking-[-0.3px]">How to be removed</h2>
          <p className="mt-6 text-ink-subtle">
            Email <a href="mailto:privacy@seriora.ai" className="underline">privacy@seriora.ai</a> and
            we will delete your address.
          </p>
        </section>
      </div>
    </main>
