 ...
 *
 * The connectors are inline SVG in `currentColor` so they inherit the ink surface's text
 * color, and nothing here animates — there is no transition or keyframe to suppress under
 * prefers-reduced-motion. The nodes are text rather than <text> inside one fixed viewBox
 * so the row can reflow into a column at the single 768px breakpoint.
 *
